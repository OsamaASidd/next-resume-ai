...
export function ProfileSelectionStep({
  ...
  return (
    <>
      ...
      {isScreenDrag && (
        <div
          className='fixed inset-0 z-50 m-0 flex items-center justify-center rounded-lg border-4 border-dashed border-primary/70 bg-primary/20 backdrop-blur-md'
      ...
      <div className='space-y-4'>
        ...
        <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-3'>
          <Card
            className={`cursor-pointer border-2 border-dashed transition-all duration-500 hover:scale-[103%] hover:border-primary`}
          >
