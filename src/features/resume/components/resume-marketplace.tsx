...
import { MarketplaceTemplate } from '@/features/resume/components/marketplace-template';
...
interface ResumeMarketplaceProps {
  resume: Resume;
}

export function ResumeMarketplace({ resume }: ResumeMarketplaceProps) {
